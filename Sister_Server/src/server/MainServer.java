		...
		try {
			...
			while(it.hasNext()){
				...
				for(int i=0; i<((ArrayList<Data>)pairs.getValue()).size(); i++){
					System.out.println(((ArrayList<Data>)pairs.getValue()).get(i).key + " " + ((ArrayList<Data>)pairs.getValue()).get(i).value + " "+ ((ArrayList<Data>)pairs.getValue()).get(i).timestamp);;
					writer.println(((ArrayList<Data>)pairs.getValue()).get(i).key + " " + ((ArrayList<Data>)pairs.getValue()).get(i).value + " "+((ArrayList<Data>)pairs.getValue()).get(i).timestamp);
				}
				writer.println("--");
			}
			writer.close();
